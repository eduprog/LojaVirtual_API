...
namespace LojaVirtual.Infra.Migrations
{
    ...
    [Migration("20200512214746_CreateTableOrderAndOrderItem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LojaVirtual.Domain.Entities.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LojaVirtual.Domain.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LojaVirtual.Domain.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LojaVirtual.Domain.Entities.OrderItem", b =>
                {
                    b.HasOne("LojaVirtual.Domain.Entities.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId");

                    b.HasOne("LojaVirtual.Domain.Entities.Order", null)
                        .WithMany("Items")
